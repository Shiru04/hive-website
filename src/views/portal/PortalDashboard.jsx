      ...
      {ticketsLoading ? (
        ...
        <div className="space-y-2 mb-8">
          {tickets.slice(0, 5).map(ticket => (
            <Link key={ticket._id} href={`/portal/tickets/${ticket._id}`}
          ...
          {tickets.length > 5 && (
            <Link href="/portal/tickets" className="block text-center text-xs text-hive-yellow py-2 hover:underline">
              View all tickets →
            </Link>
          )}
        </div>
      ...
      {dashboard?.recentInvoices?.length > 0 && (
        <>
          ...
          <div className="space-y-2 mb-8">
            ...
            <Link href="/portal/invoices" className="block text-center text-xs text-hive-yellow py-2 hover:underline">
              View all invoices →
            </Link>
          </div>
        </>
      ...
      {dashboard?.recentProjects?.length > 0 && (
        <>
          ...
          <div className="space-y-2">
            ...
            <Link href="/portal/projects" className="block text-center text-xs text-hive-yellow py-2 hover:underline">
              View all projects →
            </Link>
          </div>
        </>
