      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link href="/portal/forgot-password" className="text-xs text-slate-500 hover:text-hive-yellow transition-colors">
              Forgot password?
            </Link>
          </div>
          ...
          {config?.allowSelfRegistration && (
            <p className="text-center text-sm text-slate-500">
              ...
              <Link href="/portal/register" className="text-hive-yellow hover:underline">
                Register
              </Link>
            </p>
          )}
