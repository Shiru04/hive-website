...
/**
 * Server-rendered article view. The route's page.jsx fetches the post and
 * passes it in; `status` is "ready" | "notfound" | "error".
 */
export default function BlogPost({ post, slug, lang = "en", status = "ready" }) {
