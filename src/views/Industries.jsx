      ...
      <section className="pt-8 pb-14">
        ...
        <div className="grid gap-6 md:grid-cols-3 max-w-5xl">
          {industries.map((industry) => (
            <Link
              key={industry.slug}
              href={lp(`/industries/${industry.slug}`)}
              className="group rounded-2xl border border-slate-800 bg-slate-900/60 p-6 hover:border-hive-yellow/60 hover:shadow-lg hover:shadow-hive-yellow/5 transition flex flex-col"
            >
              ...
              <span className="inline-flex items-center gap-1 text-sm font-medium text-hive-yellow">
                ...
                <svg aria-hidden="true" className="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
