        ...
        <div className="grid gap-8 md:grid-cols-[2fr,1fr,1fr] lg:grid-cols-[2fr,1fr,1fr,1fr]">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 max-w-xs leading-relaxed">
              Digital growth agency helping service businesses generate and close more leads through performance marketing and modern technology.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li><Link to="/industries/manufacturing" className="hover:text-hive-yellow transition-colors">Manufacturing</Link></li>
            </ul>
          </div>
