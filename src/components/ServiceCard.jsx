...
export default function ServiceCard({ title, subtitle, description, bullets, slug }) {
  ...
  return (
    <article className="group rounded-2xl border border-slate-800 bg-slate-900/60 p-6 hover:border-hive-yellow/60 hover:shadow-lg hover:shadow-hive-yellow/5 transition-all shadow-sm flex flex-col">
      {icon && (
        ...
        <ul className="text-sm text-slate-400 space-y-2 mb-4">
          {bullets.map((item) => (
            <li key={item} className="flex items-center gap-2">
              <svg className="w-3.5 h-3.5 text-hive-yellow shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
