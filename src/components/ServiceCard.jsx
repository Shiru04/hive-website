...
export default function ServiceCard({ title, subtitle, description, bullets, slug }) {
  ...
  return (
    <article className="group rounded-2xl border border-slate-800 bg-slate-900/60 p-6 hover:border-hive-yellow/60 hover:shadow-lg hover:shadow-hive-yellow/5 transition shadow-sm flex flex-col">
      {icon && (
