...
export default function Hero() {
  ...
  return (
    <section className="relative pt-8 pb-16 sm:pt-12 sm:pb-20 lg:pt-16 lg:pb-24 overflow-hidden">
      ...
      <div aria-hidden="true" className="hex-lattice absolute inset-0 pointer-events-none" />
      ...
      <div className="grid gap-12 lg:grid-cols-[3fr,2fr] items-center">
        <div>
          <p className="rise rise-1 inline-flex items-center gap-2 rounded-full border border-hive-yellow/30 bg-hive-yellow/5 px-4 py-1.5 text-sm font-medium text-hive-yellow mb-6">
            <span className="w-1.5 h-1.5 rounded-full bg-hive-yellow animate-pulse" />
            {t("hero.badge")}
          </p>
          <h1 className="rise rise-2 text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6 leading-[1.1]">
            {t("hero.title_part1")}{" "}
          ...
          <p className="rise rise-3 text-lg sm:text-xl text-slate-300 max-w-xl mb-8 leading-relaxed">
            {t("hero.subtitle")}
          </p>
          <div className="rise rise-4 flex flex-wrap gap-4 mb-8">
            <Link
              href={lp("/contact")}
          ...
          {/* Stats row */}
          <div className="rise rise-5 flex flex-wrap gap-8 pt-6 border-t border-slate-800/60">
            <div>
              <div className="text-2xl font-bold text-hive-yellow"><CountUp value={t("hero.stat1_value")} /></div>
              <div className="text-sm text-slate-400">{t("hero.stat1_label")}</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-slate-50"><CountUp value={t("hero.stat2_value")} /></div>
              <div className="text-sm text-slate-400">{t("hero.stat2_label")}</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-slate-50"><CountUp value={t("hero.stat3_value")} /></div>
