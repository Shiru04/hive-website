  ...
  return (
    ...
    >
      <div className="grid gap-4">
        ...
        <a
          href="https://wa.me/18496662738"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2 rounded-full border border-emerald-600/50 bg-emerald-600/10 px-5 py-2.5 text-sm font-medium text-emerald-400 hover:bg-emerald-600/20 transition-colors"
        >
          ...
          Need a quick answer? Chat on WhatsApp
        </a>
